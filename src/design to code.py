...
class AppDesigner:
    ...
    def create_preview_area(self):
        self.preview_frame = tk.Frame(self.root, bg="#e0e0e0", width=750, height=700, relief="ridge", bd=2)
    ...
    def save_to_json(self):
        ...
        frame_id = "0:0"
        frame_name = "Frame 1"
        frame_x, frame_y, frame_w, frame_h = 0, 0, 800, 600  # ممكن تعديل
