...
def call_data(event):
    ...
    if validate_inputs(token_access, file_id, output_file_path) and check_figma_access(token_access, file_id):
        ...
        transform_json_to_tk(data, output_file_path, file_id, token_access)
        messagebox.showinfo("Success", "Tk file created successfully!")
        transform_json_to_kivy(data, output_file_path, file_id, token_access)
        messagebox.showinfo("Success", "Kivy file created successfully!")
        transform_json_to_pyqt5(data, output_file_path, file_id, token_access)
        messagebox.showinfo("Success", "PyQt5 file created successfully!")
    else:
